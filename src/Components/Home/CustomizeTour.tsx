    ...
    <>
      ...
      <div className="CustomizeTour-image">
        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item"><a href="#tours" className="nav-link">Tours</a></li>
            ...
            <div className="unique-content">
                <div className="unique-left-container">
                    <div className="unique-left-content">
                        ...
                        <p>The Surfing man will blow your mind.The Surfing man will blow your mind.The Surfing man will blow your mind.The Surfing man will blow your mind.The Surfing man will blow your mind.</p>
                ...
                <div className="unique-right-content">
                    {images.map((image, index) => (
                        <div
                            key={index}
                            className={`unique-column ${image === currentImage ? 'active' : ''}`}
